    ...
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{ route('article.create') }}"
                class="px-4 py-2 border border-yellow-500 rounded-md hover:bg-yellow-500 hover:text-white">CREATE</a>
        </div>
    </x-slot>
                    ...
                    <table class="w-full text-sm border-collapse table-auto">
                        <thead>
                            <tr>
                                ...
                                <th class="p-4 pt-0 pb-3 pl-8 font-medium text-left border-b text-slate-400">Description
                                </th>
                                <th class="p-4 pt-0 pb-3 pl-8 font-medium text-left border-b text-slate-400">Created At
                                </th>
                                ...
                                <tr>
                                    ...
                                    <td
                                        ...
                                        <a href="{{ route('article.edit', $article->id) }}"
                                            class="px-4 py-2 border border-yellow-500 rounded-md hover:bg-yellow-500 hover:text-white">EDIT</a>
                                        ...
                                        <form method="post" action="{{ route('article.destroy', $article->id) }}"
                                            ...
                                            @method('delete')
                                            <button
                                                class="px-4 py-2 border border-red-500 rounded-md hover:bg-red-500 hover:text-white">DELETE</button>
                                        </form>
                                    </td>
                                </tr>
                            @endforeach
